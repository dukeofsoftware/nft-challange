...
const LeftSection = () => {
    ...
    return (
        <div className='w-[52%] '>
            <Heading classNames='pt-[12px]  text-[40px] pb-[22px]'>
                Discover, and collect Digital Art  NFTs
            </Heading>
            <Paragraph classNames='text-[#565656] leading-[32px] text-[20px] pb-[41px] w-[470px]'>
                Digital marketplace for crypto collectibles and non-fungible tokens (NFTs). Buy, Sell, and discover exclusive digital assets.
            </Paragraph>
            <Button className='font-bold mb-[30px] py-[15px] text-[18px] relative'>
                ...
                <div className='flex gap-[23px]'>
                    {
                        bottomSection.map((item, index) => (
                            <div key={index} className='flex flex-col '>
                                <Paragraph classNames='font-integral text-[40px]  font-bold text-primaryBlack  '>{item.title}</Paragraph>
                                <Paragraph classNames='-mt-2 text-[20px]'>{item.subTitle}</Paragraph>
                            </div>
                        ))
                    }

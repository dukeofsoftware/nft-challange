...
const Col3 = () => {
  ...
  return (
    <div className="pl-[38px] border-l border-[#ECECEC]">
      <Heading classNames="font-integral font-bold leading-6 text-xl">
        Top Collections over
      </Heading>
      <Paragraph classNames="text-lg font-bold text-[#3D00B7] font-dm_sans pb-[23px]">
        Last 7 days
      </Paragraph>
      <div className="flex flex-col divide-y">
        {data.map((item, index) => (
          <div
            key={index}
            className=" flex items-center justify-between py-[14px] w-full"
          >
            <div className="flex  gap-[19px] items-center">
              ...
              <div className="w-[60px] h-[60px] rounded-full relative">
                ...
                />
                {item.ticked && (
                  <div className="absolute right-0 top-0 translate-x-[4px] -translate-y-[8px]">
                    <svg
                      width="28"
                      height="28"
                      viewBox="0 0 28 28"
              ...
              <div className="flex flex-col gap-[10px]">
                {" "}
                <Paragraph classNames="text-primaryBlack font-medium font-dm_sans">
                  {item.name}
                </Paragraph>

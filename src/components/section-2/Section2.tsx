...
const Section2 = () => {
    return (
        <div className=' w-full h-full  pt-[125px] pb-[100px]  bg-[#FFE0D9] bg-opacity-20 backdrop-filter-[25px]  '>
            <div className=' flex justify-between gap-5 max-w-[1440px] mx-auto px-[120px]'>
                <Heading classNames='font-bold text-[28px] leading-[2rem] pr-[86px]'>The amazing NFT art of the world here</Heading>
                <div className='flex gap-2 '>
                    <svg width="48" height="48" viewBox="0 10 36 36" fill="none" className=' ' xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='flex flex-col pb-3'>
                        <Heading classNames=' pb-[12px]'>Fast Transaction</Heading>
                        <Paragraph classNames='text-[#696969] text-[14px]'>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam etiam viverra tellus imperdiet.
                        </Paragraph>
                    </div>
                </div>
                <div className="flex">
                    <svg width="48" height="48" className="mr-[7px]" viewBox="0 10 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className='flex flex-col pb-3'>
                        <Heading classNames=' pb-[12px]'>Growth Transaction</Heading>
                        <Paragraph classNames='text-[#696969]'>

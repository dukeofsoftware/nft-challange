    ...
    return (
        <div className='grid grid-cols-2 py-[110px] max-w-[1440px] mx-auto px-[120px]'>
                ...
                <div className='flex flex-col items-end gap-[50px]'>
                    <div className='relative w-[300px] h-[300px]'>
                        ...
                        <Image
                            ...
                            alt="profile photo" width={70} height={70}
                        />
            ...
            <div className='flex items-center'>
                <div>
                    <Heading classNames='text-[2rem] font-bold font-integral pb-[40px]'>Create and <br/>sell your NFTs</Heading>
